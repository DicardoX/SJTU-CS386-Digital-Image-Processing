...
def equalize(image):
    ...
    equalizeImg[:, :, 0] = cv2.equalizeHist(image[:, :, 0])
    equalizeImg[:, :, 1] = cv2.equalizeHist(image[:, :, 1])
    equalizeImg[:, :, 2] = cv2.equalizeHist(image[:, :, 2])

    return equalizeImg


# def main():
#     img1 = cv2.imread("test_image/Hall/img0062.ppm")
#     img2 = cv2.imread("test_image/Hall/img0063.ppm")
#
#     img1 = equalize(img1)
#     img2 = equalize(img2)
#
